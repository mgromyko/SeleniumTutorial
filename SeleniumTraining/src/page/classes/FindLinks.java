...
//				return e.getMessage();
	...
	public static List<WebElement> clickableLinks(WebDriver driver) {
		...
		List<WebElement> allLinkedElements = driver.findElements(By.tagName("a"));
		allLinkedElements.addAll(driver.findElements(By.tagName("img")));
		
		for (WebElement e : allLinkedElements){
